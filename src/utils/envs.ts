...
interface EnvVars {
  ...
  EDIFICATIONS_CONTROLLER_HOST: string;
  EDIFICATIONS_CONTROLLER_PORT: string;
...
export const envs: EnvVars = {
  ...
  EDIFICATIONS_CONTROLLER_HOST: process.env.EDIFICATIONS_CONTROLLER_HOST,
  EDIFICATIONS_CONTROLLER_PORT: process.env.EDIFICATIONS_CONTROLLER_PORT,
